...
KEY_HINTS = [
    ...
    ('_', 'Auto-explore: walk to the nearest unexplored spot'),
...
parts.append(section('about', 'About the game',
                     guide.pop('How NetHack 1.3d differs from Angband')))
...
parts.append('<h2 id="h-version">About this version</h2><ul>'
             '<li>Based on <strong>NetHack 1.3d</strong> (1987) by Mike Stephenson and the NetHack team, '
             'from <a href="https://github.com/bhaak/NetHack-1.3d">github.com/bhaak/NetHack-1.3d</a>.</li>'
